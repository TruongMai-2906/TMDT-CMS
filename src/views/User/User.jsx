...
function User() {
  ...
  const [columm, setColumm] = useState(["Tên", "E-mail", "Số điện thoại", "Địa chỉ", "Trạng thái", "Quản lý"]);

  const [userList, setUserList] = useState([
    {
      name: "An1",
      email: "test@gmail.com",
      phoneNumber: "012255211",
      address: "test, 123 HCM",
      status: true,
    },
    {
      name: "An",
                ...
                {userList.map((user, index) =>
                  <tr>
                    ...
                    <td className="table-column-pl-0">
                      <div className="d-flex align-items-center">
                        <div className="ml-3">
                          <span className="h5 text-hover-primary">{user.name}</span>
                        </div>
                      </div>
                    </td>
                    <td>{user.address}</td>
